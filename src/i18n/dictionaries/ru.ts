  ...
  dashboard: {
    ...
    session: {
      ...
      hints: {
        ...
        walletExpired: 'Подключение кошелька истекло. Переподключите его для обновления сессии.',
        wrongWallet: 'Перед обновлением сессии переподключите кошелёк, использованный для входа.',
      },
